...
You can just leave your JSF application as is and it will work. There is however additional features that can help speed up the development process. Those features are explained here.
...
When using `data-*eventname*` you have to specify the correct target attribute as well. 
